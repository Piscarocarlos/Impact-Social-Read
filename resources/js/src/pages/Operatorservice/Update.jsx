...
export default function Create(){
    const { operator ,operator_service} = usePage().props;

  const { data, put, setData, processing, errors } = useForm({
    name_operator:operator_service.name_operator,
    type_operator:operator_service.type_operator,
    phone:operator_service.phone,
    email:operator_service.email,
    adresse:operator_service.adresse,
    ville:operator_service.ville,
    rib:operator_service.rib,
    ice:operator_service.ice,
    id:operator_service.id
  })

  const submit = (e) => {
    e.preventDefault();
    put(route('dashboard.operateur-service.update',operator_service.id), {
            ...
            <div className=" sm:w-full">
              <div className="panel">
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="my-2">
                            <label htmlFor="rib" className="text-base">Rib</label>
                        ...
                        <div className="my-2">
                            <label htmlFor="ice" className="text-base">Ice</label>
