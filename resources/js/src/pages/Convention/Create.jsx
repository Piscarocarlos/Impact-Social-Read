...
export default function Create() {
    const { famille, pack, partenaire, statut, devise, service, contact, beneficiary, critere,
        reporting, region, province, ville, filiere, year, situation, handicap, logement, orphelin } = usePage().props;
    ...
    const { data, post, setData, processing, errors } = useForm({
        ...
        dureeAccompagnement: "",
        numberBeneficiary: "",
        periodeAccompagnement: "",
        numberBeneficiaryMax: "",
        preavis: "",
        echeance: "",
        dateEffet: "",
        dateFin: "",
        ...
        montantGlobal: "",
        devise: "",
        contributionPartnaire: "",
        echeancierReglement: "",
        dateEcheanceReglement: "",
        montantReglement: "",

        dateLimiteSelection: "",
        numberBeneficiaryNextCohort: "",
        modePartner: "",
        critereSelected: "",

        typeBeneficiary: "",
        typeCritereBeneficiary: [],
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('dashboard.convention.store'), {
    ...
    const handleSave = (e) => {
        e.preventDefault();
        post(route('dashboard.save-convention.store'), {
        })
      };
        ...
        <DefaultLayout>
            <div>
                <div className="flex items-center justify-between mb-5">
                    <h5 className="font-bold text-lg dark:text-white-light">Création d'une convention</h5>
                </div>
                    ...
                    <div className="panel mb-4">
                        <div className="grid grid-cols-2  gap-3 pt-4">
                            ...
                            <div className="my-2 relative">
                                        <button type="submit" className="btn btn-success absolute inset-y-0 right-0">
