...
export default function Index({ reporting,success }) {
  ...
  const [initialRecords, setInitialRecords] = useState(sortBy(reporting, 'id'));
  ...
  useEffect(()=>{
   ...
   const handleClick=(id)=>{
    Inertia.get(route('dashboard.model-reporting.edit',id));
  }
  ...
  const handelState=(modalId)=>{
    Inertia.get(route('dashboard.model-reporting.show',modalId));
  }
    ...
    <DefaultLayout>
      <div className="panel datatables">
        <div className="flex justify-between mb-5">
          <h3 className="text-xl font-bold">Les modèles de reporting</h3>
        </div>
        
        <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
        <Link href={route('dashboard.model-reporting.create')} className="btn btn-success">Création</Link>
