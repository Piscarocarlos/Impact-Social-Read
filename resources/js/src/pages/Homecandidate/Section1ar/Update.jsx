...
export default function Create(){
  ...
  const { data, put, setData, processing, errors } = useForm({
    msg_no_candidature :section.msg_no_candidature,
    msg_candidature_cours :section.msg_candidature_cours,
    msg_candidature_attente :section.msg_candidature_attente,
    msg_info_candidature :section.msg_info_candidature,
  })

  const submit = (e) => {
    e.preventDefault();
    put(route('dashboard.section-one-candidate-ar.update',section.id), {
