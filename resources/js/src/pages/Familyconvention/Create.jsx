...
export default function Create(){
    const { beneficiaires,conventions,durations } = usePage().props;
  ...
  const submit = (e) => {
    ...
    post(route('dashboard.famille-convention.store'), {
        ...
        <div className="datatables">
          <div className=" flex justify-between flex-nowrap dark:text-white gap-4">
            <div className=" sm:w-full">
              <div className="panel">
                <h2 className="text-lg mb-3 font-bold">Création d'une famille</h2>
                <form onSubmit={submit}>
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="my-2 custom-select">
                            ...
                            <Select options={option} multiple={true} onChange={handleCibleChange} type="text" isMulti isSearchable={false}  defaultValue={data.cible}    placeholder="Sélectionner les cibles" />
