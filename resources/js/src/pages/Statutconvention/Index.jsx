...
export default function Index({ statut,success }) {
 //DATA TABBLE########################################
 ...
 const [initialRecords, setInitialRecords] = useState(sortBy(statut, 'id'));
 ...
 //FIN DATA TABLE
  ...
  const [modalId, setModalId] = useState("");
   ...
   const handleClick=(id)=>{
    Inertia.get(route('dashboard.statut-convention.edit',id));
  }
  ...
  const handelState=(modalId)=>{
    Inertia.get(route('dashboard.statut-convention.show',modalId));
  }
  const boutons = [
    ...
    <DefaultLayout>
      <div className="panel datatables">
        <div className="flex justify-between mb-5">
          <h3 className="text-xl font-bold">Liste des statut</h3>
        </div>

        <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
        <Link href={route('dashboard.statut-convention.create')} className="btn btn-success">Création</Link>
