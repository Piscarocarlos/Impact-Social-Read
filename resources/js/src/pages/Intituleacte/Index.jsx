...
export default function Index({ actes,success }) {
   //DATA TABBLE########################################
   ...
   const [initialRecords, setInitialRecords] = useState(sortBy(actes, 'id'));
  ...
  useEffect(()=>{
   ...
   const handleClick=(id)=>{
    Inertia.get(route('dashboard.intitule-acte.edit',id));
  }
  ...
  const handelState=(modalId)=>{
    Inertia.get(route('dashboard.intitule-acte.show',modalId));
  }
  const boutons = [
    ...
    <DefaultLayout>
      <div className="panel datatables">
        <div className="flex justify-between mb-5">
          <h3 className="text-lg">Les intitulés de actes</h3>
        </div>

        
        <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
        <Link href={route('dashboard.intitule-acte.create')} className="btn btn-success">Création </Link>
