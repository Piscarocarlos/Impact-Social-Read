...
export default function Create(){
    const { operator,devise,beneficiare,service } = usePage().props;
    const [selectedCible, setSelectedCible] = useState([]);
  const { data, put, setData, processing, errors } = useForm({
    name_service:service.name_service,
    description:service.description,
    cible:JSON.parse(service.cible),
    cout_unitaire:service.cout_unitaire,
    devise:service.devise,
    operator_service:service.operator_service,
  ...
  const submit = (e) => {
    e.preventDefault();
    put(route('dashboard.service.update',service.id), {
