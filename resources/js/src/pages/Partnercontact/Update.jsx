...
export default function Create(){
    const { partner,civilite,contact_partner } = usePage().props;

  const { data, put, setData, processing, errors } = useForm({
    name:contact_partner.name,
    first_name:contact_partner.first_name,
    function:contact_partner.function,
    title:contact_partner.title,
    civility:contact_partner.civility,
    email:contact_partner.email,
    phone_mobile:contact_partner.phone_mobile,
    phone_fixe:contact_partner.phone_fixe,
    profil_linkedin:contact_partner.profil_linkedin,
  })

  const submit = (e) => {
    e.preventDefault();
    put(route('dashboard.contact-partenaires.update',contact_partner.id), {
              ...
              <div className="panel">
                ...
                <form onSubmit={submit}>
                    <div className="grid grid-cols-2 gap-3">
                        <div className="my-2">
                            <label htmlFor="name" className="text-base">Nom du contact</label>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="my-2">
                            <label htmlFor="first_name" className="text-base">Prénom du contact</label>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="my-2">
                            <label htmlFor="civility" className="text-base">Civilité</label>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="my-2">
                            <label htmlFor="phone_mobile" className="text-base">Téléphone mobile</label>
                            <input type="text" value={data.phone_mobile} onChange={e => setData('phone_mobile', e.target.value)} className="form-input  " placeholder="Téléphone mobile" />
                            {errors.phone_mobile && <div className="text-danger">{errors.phone_mobile}</div>}
                        </div>
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                        <div className="my-2">
                            <label htmlFor="phone_fixe" className="text-base">Téléphone fixe</label>
                            <input type="text" value={data.phone_fixe} onChange={e => setData('phone_fixe', e.target.value)} className="form-input  " placeholder="Téléphone fixe" />
