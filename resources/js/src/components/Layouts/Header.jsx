                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            <img className="w-8 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo1.png" alt="logo" />
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">IMPACT SOCIAL</span>
                        </Link>
                        <button
                            type="button"
                       ...
                       {/* <div className="dropdown shrink-0">
                        ...
                        <div className="dropdown shrink-0 flex">
                            <Dropdown
                                ...
                                button={<img className="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src={user.avatar!=null? `/storage/`+user.avatar:userImage} alt="userProfile" />}
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            <img className="rounded-md w-10 h-10 object-cover" src={user.avatar!=null? `/storage/`+user.avatar:userImage} alt="userProfile" />
                                    ...
                                    <li>
                                        <Link href={route('dashboard.profil.candidate')} className="dark:hover:text-white">
                                    ...
                                    <li className="border-t border-white-light dark:border-white-light/10">
                                        <Link href={route('logout')} className="text-danger !py-3">
                ...
                <ul className="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-black text-black dark:text-white-dark">
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <Link to="/forms/checkbox-radio">{t('checkbox_&_radio')}</Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/forms/date-picker">{t('date_&_range_picker')}</Link>
                            </li>
                            <li>
